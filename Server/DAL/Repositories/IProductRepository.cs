...
internal interface IProductRepository
{
    ...
    /// <returns>Возвращает сущность из базы данных, если продукт с заданным
    /// Id пристуствует в базе данных</returns>
    Task<Product?> GetProductById(long id, CancellationToken token);
    /// <summary>
    /// Добавляет продукт в базу данных
    /// </summary>
    /// <param name="newProduct">Сущность для добавления в базу данных
    /// с заполненными полями Name и Cost(опционально)</param>
